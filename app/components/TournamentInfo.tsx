  ...
  return (
    <div className="flex items-center gap-4">
      <div className="flex-1 px-5 py-4 text-center">
        {data.name && (
          <h2
            className={`text-6xl font-extrabold tracking-tight ${isDark ? "text-white" : "text-gray-900"}`}
          >
            {data.name}
          </h2>
        )}
        ...
        <div
          className={`mt-2 flex flex-wrap justify-center gap-x-3 gap-y-1 text-2xl ${isDark ? "text-gray-300" : "text-gray-600"}`}
        >
          {[
            data.date &&
